...
export const MODULE_KEYS = ["dashboard", "capture", "organization", "locations", "transfers", "reports", "intelligence", "assistant", "ai_reports", "administration"] as const;
...
export const MODULE_LABELS: Record<ModuleKey, { ar: string; en: string }> = {
  ...
  assistant: { ar: "مساعد AssetLens الذكي", en: "AssetLens AI Assistant" },
...
export function defaultModulePermissions(role: UserRole): ModulePermission[] {
  ...
  if (role === "admin") {
    for (const moduleKey of MODULE_KEYS) {
      if (moduleKey === "assistant" || moduleKey === "ai_reports") continue;
      allow(access(moduleKey, { create: true, edit: true, delete: true, approve: true, export: true }));
    }
  } else if (role === "project_manager") {
    allow(access("dashboard", { export: true }));
    allow(access("capture", { create: true, edit: true }));
    allow(access("organization"));
    allow(access("locations", { edit: true }));
    allow(access("transfers", { create: true, edit: true }));
    allow(access("reports", { edit: true, approve: true, export: true }));
    allow(access("intelligence", { create: true, edit: true, approve: true, export: true }));
  } else if (role === "reviewer") {
    allow(access("dashboard"));
    allow(access("organization"));
    allow(access("locations", { edit: true }));
    allow(access("reports", { edit: true, approve: true, export: true }));
    allow(access("intelligence", { export: true }));
...
export function normalizeModulePermissions(value: unknown, role: UserRole, superAdmin = false): ModulePermission[] {
  if (superAdmin) return defaultModulePermissions("admin").map(permission =>
    permission.module === "assistant" || permission.module === "ai_reports"
      ? access(permission.module, { create: true, edit: true, delete: true, approve: true, export: true }) : permission);
