...
export default function AdminPage() {
  ...
  const [locationLevelParentId, setLocationLevelParentId] = useState("");
  const [locationLevelId, setLocationLevelId] = useState("");
  const [locationParentOptionId, setLocationParentOptionId] = useState("");
  const [locationOfficeId, setLocationOfficeId] = useState("");
