...
function TransfersContent() {
  ...
  async function transfer() {
    ...
    try {
      ...
      const response = await fetch("/api/assets",{method:"PATCH",headers:{Authorization:`Bearer ${token}`,"Content-Type":"application/json"},body:JSON.stringify({action:"transfer",id:selectedAsset.id,projectId:selectedAsset.projectId,buildingId,floorId,zoneId,officeId,additionalLocations:dynamicLocations.filter(item=>item.value)})});
